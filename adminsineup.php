...
echo $mobilenumber;
   ...
   $sql="INSERT INTO `admin` (`id`, `name`, `date of birth`, `gender`, `phoneno`, `email`, `address`, `city`, `state`, `country`,`upload_img`, `username`, `password` , `status`) VALUES ('','$name','$dateofbirth','$gender','$mobilenumber','$email','$Address','$City','$State','$Country','$content','$Username','$Password','no')";
