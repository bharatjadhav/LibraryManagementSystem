...
$issueid = $row["id"];    
            ...
            echo "<td><a href='return.php?l_id=";echo $row["bookid"];echo"&mid=";echo $memberid;echo"&issueid=";echo $issueid;echo"&availablebook=";echo $availablebook;echo"'>Return </a></td>";
}
