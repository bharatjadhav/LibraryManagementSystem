...
{
    $email = $_POST['email'];
    $sql="SELECT * FROM `sineup` WHERE `email` = '$email'";
  ...
  if(mysqli_num_rows($result)==1)
  {
    ...
    $link="<a href='http://localhost/may/resetm.php?key=".$email."&reset=".$pass."&id=".$id."'>Click To Reset password</a>";
...
echo $lemail;
    ...
    echo "<script>alert('Check Your Email is invalide '); window.location='homepa.html'; </script>";
