...
require_once("connection.php") ?>
  ...
  <div class="bg"> Librarian  Login</div>
    ...
    <br>
        <button type="submit" name="submit"><font>Login</font></button><br> Forgot <a href="forgetpassl.php">password?</a></span>
    </center>
</form>
...
?>
    ...
    echo $password =mysqli_real_escape_string($conn, md5($_POST['Password']));
        ...
        $count=0;
        $sqlq = "select * from libsineup where username= '$username' && password= '$password' && status = 'yes'";
    ...
    if($count==0)
        {
            echo " InvalidUSERNAME AND PASSWORD";
                    ...
                    else{$_SESSION["lsineup"] = $username;
